...
![alt text](https://github.com/EstebanLFalcon/MusicAtAPI/tree/master/app/assets/images/response_json.PNG "playlist response")
...
The `GET` reponse has the following structure:
![alt text](https://github.com/EstebanLFalcon/MusicAtAPI/tree/master/app/assets/images/moods_json.PNG "moods response")
...
The `GET` reponse has the following structure:
![alt text](https://github.com/EstebanLFalcon/MusicAtAPI/tree/master/app/assets/images/places_json.PNG "places response")
Note that we do show the raw response as it is easy to read.
