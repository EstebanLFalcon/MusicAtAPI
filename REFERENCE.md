...
![Screenshot](http://imgur.com/a/gMBPK?raw=true)
...
The `GET` reponse has the following structure:
![Screenshot](https://github.com/EstebanLFalcon/MusicAtAPI/app/assets/images/moods_json.PNG?raw=true "moods response")
